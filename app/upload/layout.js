export const metadata = {
  ...
  description: 'Apni koi bhi lab report upload karo — CBC, Thyroid, HbA1c, Vitamin D. 30 seconds mein Hindi mein result. SRL, Lal PathLabs, Apollo, Thyrocare supported.',
  keywords: [
    'lab report upload hindi', 'blood test report analyzer',
    'medical report hindi mein', 'CBC report analyze',
    'thyroid report hindi', 'ai medical report analyzer india',
  ],
