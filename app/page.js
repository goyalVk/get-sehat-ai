...
const faqSchema = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type':'Question', name:'Kya Sehat24 bilkul free hai?',             acceptedAnswer:{ '@type':'Answer', text:'Reports analyze karne ke liye Pro plan lena hota hai — sirf ₹499/month mein unlimited reports milte hain. Koi hidden charge nahi.' } },
